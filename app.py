#nama kelompok :
# 6B_19090096_Aditiya Prayogy 
# 6B_19090127_Miftakhul Anam
# 6B_19090080_M.Salman Septianto
# 6B_19090109_DIMAS ARDIANSYAH
...
database_file = "sqlite:///{}".format(os.path.join(project_dir, "Uts_aditiya.db"))
